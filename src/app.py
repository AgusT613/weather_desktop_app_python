...
class App(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        # City [str]
        self.city = StringVar(value = self.weather.get_weather_value()["city"])
        ...
        # Country [str]
        self.country = StringVar(value = self.weather.get_weather_value()["country"])
        ...
        self.temperature = StringVar(value = self.weather.get_weather_value()["temperature"]) #----> Later this value will be changing dinamically
        ...
        self.condition = StringVar(value = self.weather.get_weather_value()["condition"])
